"""
Django settings for sp_website project.
...
SECRET_KEY = "django-insecure-nfpfef$xx0es3t$hae#7*9w6s_5-p(#i&aj9+apb=sayi$u%xo"
...
WSGI_APPLICATION = "sp_website.wsgi.application"
